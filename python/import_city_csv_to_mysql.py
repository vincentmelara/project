# --------------------------------------------------------------------------------
# Author:       Tim Allec
# File name:    import_city_csv_to_mysql.py
# Date Created: 2024-09-11
#
# Description: This script imports city-level census demographic data from a CSV 
#              file ('census_city_demographics_2022.csv') into a MySQL database 
#              table named 'census_city_demographics_2022'. The script handles 
#              table creation, data insertion, and renaming of columns to make them 
#              MySQL-friendly. If the table already exists, data insertion is 
...
# Set up logging
logger = logging.getLogger('import_city_csv_to_mysql.py')
...
# CSV file path (update for your local path)
csv_file_path = r'C:\Users\User\Downloads\census_city_demographics_2022.csv'
table_name = 'census_city_demographics_2022'
